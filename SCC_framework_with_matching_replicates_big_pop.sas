/*Testing matching*/
LIBNAME res 'C:\Users\webst\OneDrive\Documents\PS Caliper simulations\Results_bigger_pop';
...
%createSCCsim(name=trialrun,n=4500,repstart=&icon,repend=&icon,seed=1250+&icon, /*We'll create 1 dataset named "trialrun" with 100,000 people, with 1 replicate and a seed of 1250*/
