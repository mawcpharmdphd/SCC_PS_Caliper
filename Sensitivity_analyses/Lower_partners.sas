/*Testing matching*/
LIBNAME res 'C:\Users\webst\OneDrive\Documents\PS Caliper simulations\Results_lower_partners';
...
%createSCCsim(name=trialrun,n=450,repstart=&icon,repend=&icon,seed=1250+&icon, /*We'll create 1 dataset named "trialrun" with 100,000 people, with 1 replicate and a seed of 1250*/
					INPUTC1=0.5,PC1C2=0.2,PC1X=0.075,PC1Y=0.075,
					INPUTC2=0.1,PC2X=0.1,PC2Y=0.05,
					INPUTX=0.15,PXY=0.05,
					INPUTY=0.05,
					MEANPC3X=1,
					DEVPC3X=1,
					MEANPC3Y=1,
