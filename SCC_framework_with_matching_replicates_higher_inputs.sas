/*Testing matching*/
LIBNAME res 'C:\Users\webst\OneDrive\Documents\PS Caliper simulations\Results_doubled_inputs';
...
%createSCCsim(name=trialrun,n=450,repstart=&icon,repend=&icon,seed=1250+&icon, /*We'll create 1 dataset named "trialrun" with 100,000 people, with 1 replicate and a seed of 1250*/
					INPUTC1=0.75,PC1C2=0.4,PC1X=0.1,PC1Y=0.1,
					INPUTC2=0.2,PC2X=0.2,PC2Y=0.1,
					INPUTX=0.3,PXY=0.1,
					INPUTY=0.10,
					MEANPC3X=2,
					DEVPC3X=1,
